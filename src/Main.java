    ...
    public static URL getURLInput() {
        ...
        while (userURL == null) {
            try {
                ...
                String getUserInput = JOptionPane.showInputDialog(null, "Please enter a valid URL!");
                ...
                JOptionPane.showMessageDialog(null, "Please enter a valid URL", "Failed to resolve link", JOptionPane.ERROR_MESSAGE);
            }
        }
